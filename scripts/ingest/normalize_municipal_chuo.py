"""Normalization entrypoint for Chuo ward candidates."""
...
def normalize_municipal_chuo_payload(
...
__all__ = ["normalize_municipal_chuo_payload", "MunicipalNormalizationResult"]
