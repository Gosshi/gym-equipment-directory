...
TRUSTED_DOMAINS = {
    # Tokyo wards - various TLD patterns
    "city.chuo.lg.jp",
    "city.koto.lg.jp",
    "city.koto.tokyo.jp",
    ...
    "city.katsushika.tokyo.jp",
    "city.edogawa.tokyo.jp",
    "city.edogawa.lg.jp",
    "city.chiyoda.lg.jp",
    # External municipal sports facility sites
    "spo.katsushika-web.net",
    "taitogeibun.net",
    # Commercial chains
    "konami.com",
    "central.co.jp",
