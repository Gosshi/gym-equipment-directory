...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('source_type', sa.Enum('official_site', 'on_site_signage', 'user_submission', 'media', 'sns', 'other', name='sourcetype'), nullable=False),
    ...
    sa.Column('availability', sa.Enum('present', 'absent', 'unknown', name='availability'), nullable=False),
    sa.Column('count', sa.Integer(), nullable=True),
    sa.Column('max_weight_kg', sa.Integer(), nullable=True),
    sa.Column('notes', sa.String(), nullable=True),
    sa.Column('verification_status', sa.Enum('unverified', 'user_verified', 'owner_verified', 'admin_verified', name='verificationstatus'), nullable=False),
    ...
    sa.Column('status', sa.Enum('pending', 'corroborated', 'approved', 'rejected', name='submissionstatus'), nullable=False),
