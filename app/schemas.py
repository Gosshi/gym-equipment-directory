...
class GymBasic(BaseModel):
    ...
    pref: str | None = Field(None, description="都道府県スラッグ")
    city: str | None = Field(None, description="市区町村スラッグ")
...
class EquipmentHighlight(BaseModel):
    ...
    last_verified_at: datetime | None = Field(None, description="設備情報の最終確認時刻")
...
class SearchItem(BaseModel):
    ...
    last_verified_at: datetime | None = Field(
        None, description="ジムに紐づく設備の最終確認（最大）"
    )
